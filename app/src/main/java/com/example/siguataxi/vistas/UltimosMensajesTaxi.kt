...
import kotlinx.android.synthetic.main.ultimos_mensajes_taxi.view.*

class UltimosMensajesTaxi (val mensajesChat: MensajeChatClase): Item<ViewHolder>() {
    var chatAmigo: Usuario? = null

    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.mensaje_textview_ultimos_mensajes_taxi.text = mensajesChat.texto
        ...
        ref.addListenerForSingleValueEvent(object: ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                viewHolder.itemView.usuario_textview_ultimos_mensajes_taxi.text = chatAmigo?.nombreUsuario

                val targetImageView = viewHolder.itemView.img_ultimos_mensajes_taxi
    ...
    override fun getLayout(): Int {
        return R.layout.ultimos_mensajes_taxi
    }
}